...
@section('content')
        <div class="container bg-afaak rounded p-2">
            <div class="container custom-color p-2 rounded">
                <div class="row">
                    <div class="col-md-12">
                        {!! Form::open(['action' => "PostsController@store", 'method'=> 'POST', 'id' => 'regForm']) !!}
                            <h1 id="register"></h1>
                                ...
                                <div class="tab"><!-- Phase 2: Login Details-->
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <p><input placeholder="Enter Password" type="password" voninput="this.className = ''" name="passwd" required></p>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-4 d-flex">
                                ...
                                <div class="tab"><!-- Phase 5: Submission-->
                                    <p>Preferred word Period Range:</p>
